        ...
        for camera_idx in progress.track(range(cameras.size), description=""):
            ...
            for rendered_output_name in rendered_output_names:
                ...
                if rendered_output_name == 'uncertainty':
                    output_image = colormaps.apply_colormap(output_image, cmap="inferno").cpu().numpy()
...
class RenderTrajectory:
    ...
    rendered_output_names: List[str] = field(default_factory=lambda: ["rgb", "uncertainty"])
    ...
    def main(self) -> None:
        ...
        pipeline.model.filter_out = False
